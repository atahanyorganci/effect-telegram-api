...
export class TelegramClient extends Context.Service<
	TelegramClient,
	{
		...
		readonly close: () => Effect.Effect<
			true,
			Errors.NotFound | Errors.Unauthorized | TelegramApiError | HttpClientError.HttpClientError
		>;
		/**
		...
		readonly getChatMenuButton: (payload: {
			...
			unknown,
			Errors.InvalidChatId | Errors.NotFound | Errors.Unauthorized | TelegramApiError | HttpClientError.HttpClientError
		>;
		/**
		...
		readonly getManagedBotAccessSettings: (payload: {
			...
			BotAccessSettings,
			Errors.InvalidUserId | Errors.NotFound | Errors.Unauthorized | TelegramApiError | HttpClientError.HttpClientError
		>;
		/**
		...
		readonly sendMediaGroup: (payload: {
			...
			ReadonlyArray<Message>,
			Errors.MediaRequired | Errors.NotFound | Errors.Unauthorized | TelegramApiError | HttpClientError.HttpClientError
		>;
		/**
		...
		readonly unpinAllChatMessages: (payload: {
			...
			true,
			Errors.ChatIdEmpty | Errors.NotFound | Errors.Unauthorized | TelegramApiError | HttpClientError.HttpClientError
		>;
		/**
